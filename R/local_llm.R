...
#' - llama-server (llama.cpp) reference: https://github.com/ggml-org/llama.cpp/tree/master/tools/server
#'
...
#' Function-call trick for all models: uses tool calling to simulate structured outputs, always requiring
