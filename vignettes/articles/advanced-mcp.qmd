...
::: {.callout-note appearance="simple"}
The Semantic Scholar MCP server code is available at `inst/examples/semantic_scholar_mcp_server.R`.
:::
...
::: {.callout-tip appearance="simple"}
You can use this server with other MCP clients by configuring them to connect to `http://127.0.0.1:8080`.
:::
