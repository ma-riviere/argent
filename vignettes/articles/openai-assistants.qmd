---
title: "OpenAI Assistants API (DEPRECATED)"
format: html
execute:
  echo: true
  eval: false
...
Let's send two PDF URLs and use the `as_text_content()` helper to have `pdftools::pdf_convert()` parse the PDFs
and pass the text content to the model instead of passing base64.
