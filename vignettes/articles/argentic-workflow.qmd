...
::: {.callout-note appearance="simple"}
See the [MCP: Connecting to MCP Servers](/articles/mcp-client) article for more details on how to use MCP servers with `argent`.
:::
...
```{json}
#| code-fold: true
#| code-summary: "JSON output of the main agent's answer"
