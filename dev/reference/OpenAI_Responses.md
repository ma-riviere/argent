...
[`argent::Provider`](https://ma-riviere.github.io/argent/dev/reference/Provider.md)
-\>
[`argent::OpenAI`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.md)
-\> `OpenAI_Responses`
...
- [`argent::Provider$download_generated_files()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-download_generated_files)
- [`argent::Provider$dump_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-dump_history)
- [`argent::Provider$get_auto_save_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_auto_save_history)
- [`argent::Provider$get_chat_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_chat_history)
- [`argent::Provider$get_content_text()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_content_text)
- [`argent::Provider$get_generated_code()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_generated_code)
- [`argent::Provider$get_generated_files()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_generated_files)
- [`argent::Provider$get_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_history)
- [`argent::Provider$get_history_file_path()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_history_file_path)
- [`argent::Provider$get_last_response()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_last_response)
- [`argent::Provider$get_rate_limit()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_rate_limit)
- [`argent::Provider$get_reasoning_text()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_reasoning_text)
- [`argent::Provider$get_session_cumulative_token_count()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_session_cumulative_token_count)
- [`argent::Provider$get_session_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_session_history)
- [`argent::Provider$get_session_last_token_count()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_session_last_token_count)
- [`argent::Provider$get_supplementary()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-get_supplementary)
- [`argent::Provider$load_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-load_history)
- [`argent::Provider$print()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-print)
- [`argent::Provider$reset_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-reset_history)
- [`argent::Provider$set_auto_save_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-set_auto_save_history)
- [`argent::Provider$set_history()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-set_history)
- [`argent::Provider$set_rate_limit()`](https://ma-riviere.github.io/argent/dev/reference/Provider.html#method-set_rate_limit)
- [`argent::OpenAI$add_file_to_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-add_file_to_store)
- [`argent::OpenAI$create_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-create_store)
- [`argent::OpenAI$delete_all_files()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_all_files)
- [`argent::OpenAI$delete_all_files_from_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_all_files_from_store)
- [`argent::OpenAI$delete_all_stores()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_all_stores)
- [`argent::OpenAI$delete_file()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_file)
- [`argent::OpenAI$delete_file_from_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_file_from_store)
- [`argent::OpenAI$delete_files()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_files)
- [`argent::OpenAI$delete_files_from_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_files_from_store)
- [`argent::OpenAI$delete_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_store)
- [`argent::OpenAI$delete_store_and_files()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_store_and_files)
- [`argent::OpenAI$delete_stores()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-delete_stores)
- [`argent::OpenAI$download_file()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-download_file)
- [`argent::OpenAI$embeddings()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-embeddings)
- [`argent::OpenAI$find_assistants()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-find_assistants)
- [`argent::OpenAI$find_file()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-find_file)
- [`argent::OpenAI$find_file_in_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-find_file_in_store)
- [`argent::OpenAI$find_models()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-find_models)
- [`argent::OpenAI$find_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-find_store)
- [`argent::OpenAI$get_file()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-get_file)
- [`argent::OpenAI$get_file_content()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-get_file_content)
- [`argent::OpenAI$get_model_info()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-get_model_info)
- [`argent::OpenAI$list_assistants()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-list_assistants)
- [`argent::OpenAI$list_files()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-list_files)
- [`argent::OpenAI$list_files_in_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-list_files_in_store)
- [`argent::OpenAI$list_models()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-list_models)
- [`argent::OpenAI$list_stores()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-list_stores)
- [`argent::OpenAI$read_file_from_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-read_file_from_store)
- [`argent::OpenAI$read_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-read_store)
- [`argent::OpenAI$update_store()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-update_store)
- [`argent::OpenAI$upload_file()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-upload_file)
- [`argent::OpenAI$upload_file_from_df()`](https://ma-riviere.github.io/argent/dev/reference/OpenAI.html#method-upload_file_from_df)
...
- `tools`:
  ...
  - list(type = "file_search", store_ids = list("vs_123")) for file
    ...
    the `as_tool(fn)` or
    [`tool()`](https://ma-riviere.github.io/argent/dev/reference/tool_definitions.md)
    helpers.
