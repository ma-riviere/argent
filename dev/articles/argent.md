...
- [Google
  Gemini](https://ma-riviere.github.io/argent/dev/articles/articles/google-gemini.md)
- [Anthropic
  Claude](https://ma-riviere.github.io/argent/dev/articles/articles/anthropic.md)
- [OpenRouter](https://ma-riviere.github.io/argent/dev/articles/articles/openrouter.md)
- [Local
  LLMs](https://ma-riviere.github.io/argent/dev/articles/articles/local-llm.md)
...
- [Chat Completions
  API](https://ma-riviere.github.io/argent/dev/articles/articles/openai-completions.md) -
  Standard OpenAI chat interface
- [Responses
  API](https://ma-riviere.github.io/argent/dev/articles/articles/openai-responses.md) -
  Newest API combining the functionalities of the Chat and Assistants
- [Assistants
  API](https://ma-riviere.github.io/argent/dev/articles/articles/openai-assistants.md) -
  Deprecated

##### Other Providers

- [Using Other Compatible
  APIs](https://ma-riviere.github.io/argent/dev/articles/articles/other-providers.md) -
  Use argent with providers offering compatible APIs (e.g., Minimax,
  Qwen, …)

#### Advanced Topics

- [RAG](https://ma-riviere.github.io/argent/dev/articles/articles/basic-rag.md) -
  How to use `argent` & `ragnar` for RAG
- [MCP: Connecting to MCP
  Servers](https://ma-riviere.github.io/argent/dev/articles/articles/mcp-client.md) -
  How to connect to MCP servers with `argent`
- [MCP: Creating MCP
  Servers](https://ma-riviere.github.io/argent/dev/articles/articles/mcp-server.md) -
  How to create your own MCP servers with `argent`
- [Argentic
  Workflow](https://ma-riviere.github.io/argent/dev/articles/articles/argentic-workflow.md) -
