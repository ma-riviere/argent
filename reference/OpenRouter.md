...
R6 class for interacting with OpenRouter's API. Provides access to
multiple LLM providers through a unified interface with support for chat
completions, tool calling, and structured outputs.
