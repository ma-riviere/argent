...
I started working on this back in 2023 when none of the existing LLM packages supported tool calling or structured outputs, but I never took the time to put everything into a proper package until now.

However, there are now several similar packages, including [ellmer](https://github.com/tidyverse/ellmer) by the Tidyverse team, which I recommend using instead.
...
I will be progressively migrating my projects to `ellmer`, and I am not sure how long I'll maintain `argent`.
